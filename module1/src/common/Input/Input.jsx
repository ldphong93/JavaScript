...
export const mockedCoursesListWithAuthorsName = mockedCoursesList.map(
	(course) => {
		//duration format
		...
		//date format
		const [month, date, year] = course.creationDate.split('/');
		...
		return {
			...
			authors: course.authors
				.map((authorId) => {
					...
					return foundAuthor ? foundAuthor.name : 'Author not found';
				})
				.join(', '),
